...
////////////////// Some steam IDs can't be found with multiple game lookup
// Need to use / store data[i].gameID instead of data[i].steamAppID
// Might need to keep steamAppID for pictures if gameID can't look them up.
let testIdList = [128, 154, 267454];

// Make API call. For each object in data, append the HTML generated by each instance of GalleryItem after sanitizing.
fetch("https://www.cheapshark.com/api/1.0/games?ids=" + testIdList, requestOptions)
...
$('.gallery').on('click', '.heart', function(event) {
  ...
  ////////////////// Add function to refresh cards list on click.
